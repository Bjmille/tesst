if not ( wOS.ALCS.Config.Crafting.ShouldCraftingUseMySQL or wOS.ALCS.Config.Character.ShouldUseMySQL or wOS.ALCS.Config.Skills.ShouldSkillUseMySQL ) then return end
